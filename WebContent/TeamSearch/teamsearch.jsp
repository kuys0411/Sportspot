      ...
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" id="error_confirm_button" class="btn btn-default" data-dismiss="modal">확인</button>
...
&nbsp;<h2>스포츠 타입</h2>
<div class="icon">
<img src="../Resources/images/image_kyy/soccer.png" name="soccer" onclick="Check(this.name,'')"> 
<img src="../Resources/images/image_kyy/baseball.png" name="baseball" onclick="Check(this.name,'')">
<img src="../Resources/images/image_kyy/badminton.png" name="badminton" onclick="Check(this.name,'')">
<img src="../Resources/images/image_kyy/goggles.png" name="goggles" onclick="Check(this.name,'')"> 
<img src="../Resources/images/image_kyy/golf.png" name="golf" onclick="Check(this.name,'')">
<img src="../Resources/images/image_kyy/tennis-ball.png" name="tennis-ball" onclick="Check(this.name,'')">
<img src="../Resources/images/image_kyy/ice-skating.png" name="ice-skating" onclick="Check(this.name,'')">
<img src="../Resources/images/image_kyy/hockey.png" name="hockey" onclick="Check(this.name,'')">
<img src="../Resources/images/image_kyy/roller-skate.png" name="roller-skate" onclick="Check(this.name,'')">
<img src="../Resources/images/image_kyy/archery.png" name="archery" onclick="Check(this.name,'')">
<img src="../Resources/images/image_kyy/target.png" name="target" onclick="Check(this.name,'')">
<img src="../Resources/images/image_kyy/others.png" name="others" onclick="Check(this.name,'')">
<br>
...
<br>
 ...
 <div class="input-group">
   <input type="text" class="form-control" placeholder="동명을 입력하세요 ex)잠실동 " id="P_doro" onkeydown="if (event.keyCode == 13)
                        document.getElementById('searchInput').click()"   name="P_doro">
         ...
         <div class="row">
          ...
          <div class="col-sm-12 col-md-6">
            <div class="footer_info">
              ...
              <p> (주)삶넥스트 | 사업자등록번호: 887-81-00575 | 대표: BAIGWOONYONG, 이정헌 |  
