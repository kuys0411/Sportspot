	...
	<div class="main-agileits">
		...
		<div class="sub-main">
			<form action="signup" method="post">
				...
				<br> <input placeholder="Name" name="Name" class="name2"
					type="text" required> <br> <input placeholder="Email"
					name="mail" class="mail" type="text" required> <br> <input
				...
				<div id="interest"> Choose Interest <br> 
					<input type="radio" name="interest" value="football" checked> Football 
					<input type="radio"	name="interest" value="baseball"> Baseball 
					<input  type="radio" name="interest" value="badminton"> Badminton<br>
					<input type="radio" name="interest" value="swimming"> Swimming 
					<input type="radio" name="interest" value="golf">Golf
					<input type="radio" name="interest" value="ice"> Ice Sports <br>
					<input type="radio" name="interest" value="Roller"> Roller Skates
					<input type="radio" name="interest" value="archery"> Archery<br> 
					<input type="radio" name="interest" value="shooting"> Shooting
